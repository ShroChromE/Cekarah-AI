        ...
        <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4 py-10">
            ...
            <div className="w-full max-w-sm">
                <div className="mb-8 text-center">
                    ...
                    <h1 className="mt-4 text-xl font-bold text-slate-900">Daftar Relawan</h1>
                    <p className="mt-1 text-sm text-slate-500">Buat akun untuk berkontribusi data resmi.</p>
                </div>

                <Form action="/register" method="post" className="space-y-4 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                    {({ errors, processing }) => (
                        <>
                            <div>
                            ...
                            <div>
                                <label className="mb-1 block text-sm font-medium text-slate-700">Ulangi kata sandi</label>
                                <input
                                    type="password"
